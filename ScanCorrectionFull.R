...
rawScan <- fread("RawData/Scans_Spring2018/AnalyzedScans_DAT_SUM/TW-17-19-5.dat",
            skip=40, 
            fill = T, 
            header = F, 
...
write.table(corScan, file = 'IntermediateData/CorrectedScans/TW-17-19-5', 
